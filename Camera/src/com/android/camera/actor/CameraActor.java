...
import com.android.camera.ui.preViewListner;//added by wangyouyou for pictrue preview
import android.hardware.Camera.PreviewCallback;//added by wangyouyou for pictrue preview
...
public abstract class CameraActor {
    ...
    protected preViewListner[] mPl;//added by wangyouyou
 ...
 public void setPreViewListners(preViewListner[] paramArrayOfpreViewListner)
  {
    this.mPl = paramArrayOfpreViewListner;
  }
  ...
  /*End added by wangyouyou for pre effect*/
    ...
    public CameraModeType getCameraModeType(int newMode) {
        ...
        case ModePicker.MODE_MAV:
            mode = CameraModeType.EXT_MODE_MAV;
            break;
        ...
        case ModePicker.MODE_MOTION_TRACK:
            mode = CameraModeType.EXT_MODE_MOTION_TRACK;
            break;
        ...
        case ModePicker.MODE_LIVE_PHOTO:
            mode = CameraModeType.EXT_MODE_LIVE_PHOTO;
            break;
