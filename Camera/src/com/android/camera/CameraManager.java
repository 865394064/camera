...
import com.android.camera.ICamera;
...
public class CameraManager {
    ...
    public class CameraProxy {
        ...
        //begin added by wangyouyou
        public void setPreviewCallback(PreviewCallback paramPreviewCallback)
	    {
		  mCameraHandler.obtainMessage(4096, paramPreviewCallback).sendToTarget();
	    }
        //end added by wangyouyou
        ...
        public void setMotionTrackCallback(MotionTrackCallback motionTrackCallback) {
            mCameraHandler.obtainMessage(SET_MOTIONTRACK_CALLBACK, motionTrackCallback)
                    .sendToTarget();
            waitDone();
        }
