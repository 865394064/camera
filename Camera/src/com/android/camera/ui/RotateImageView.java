...
import android.graphics.Paint;//added by wangyouyou
import android.graphics.Color;//added by wangyouyou
...
public class RotateImageView extends TwoStateImageView implements Rotatable {
    ...
    private String picText = " ";//added by wangyouyou
    private int picColor = Color.WHITE;//added by wangyouyou
    ...
    public void setPicText(String str, int color){
	picText = str;
	picColor = color;
    }
	...
	//begin:added by wangyouyou
	 Paint textPaint = new Paint( Paint.ANTI_ALIAS_FLAG);  
	  ...
	  textPaint.setColor(picColor);
        canvas.drawText(picText, 20, 55, textPaint);
	 //end:added by wangyouyou
        if (drawable == null) {
