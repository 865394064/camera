...
public class SettingUtils {
    ...
    public static final String PICTURE_RATIO_1_1 = "1.0";//added by wangyouyous
    ...
    public static final double[] RATIOS = new double[] {  1.0, 1.3333, 1.5, 1.6667, 1.7778 };//modified by wangyouyou
    ...
    public static SharedPreferences mSharedPreferences;//added by wangyouyou
    ...
    public static void setPictureSize(Context context, Parameters parameters,
            ...
            //Log.d("wyy", "----->pictureSize = "+pictureSize);
        if (pictureSize == null) {
    ...
    public static void setPreviewSize(Context context, Parameters parameters, String prviewRatio) {
        ...
        if (!original.equals(optimalSize) ) {
            ...
            //parameters.setPreviewSize(1080, 1080);//added by wangyouyou
        }
    ...
    public static void initialCameraPictureSize(Context context, Parameters parameters, 
        ...
        if (supportedRatios != null && supportedRatios.size() > 0) {
            SharedPreferences.Editor editor = sharedPreferences.edit();
            ratioString = supportedRatios.get(0);// mody by xss from supportedRatios.size() - 1 to 0;
            editor.putString(SettingConstants.KEY_PICTURE_RATIO, ratioString);
			//Log.d("wyy", "changeMode----->ratioString = "+ratioString);     
            editor.apply();
        }
        ...
        if (supportedSizes != null && supportedSizes.size() > 0) {
			...
			//Log.d("wyy", "changeMode----->findPictureSize = "+findPictureSize);
            editor.apply();
    ...
    public static void changePreview(String previewSize, CameraActivity context){
	  SharedPreferences.Editor editor = context.getSharePreferences().edit();   
	  editor.putString(SettingConstants.KEY_PICTURE_RATIO, previewSize);
    ...
    public static List<String> buildPreviewRatios(Context context, Parameters parameters) {
        ...
        if (context != null && parameters != null) {
            ...
            if (!supportedRatios.contains(findString)) {
                                                         // ratio
                supportedRatios.add(SettingUtils.getRatioString(4d / 3));											 
            }else
                supportedRatios.add(SettingUtils.getRatioString(4d / 3));
	     supportedRatios.add("1.0");//added by wangyouyou
	     supportedRatios.add("1.7778");//added by wangyouyou
        }
