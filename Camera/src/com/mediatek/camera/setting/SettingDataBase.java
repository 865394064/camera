...
public class SettingDataBase {
    ...
    static {
                                                                                             //   normal      hdr    facebeauty  panorama    mav      asd    motiontrack  photopip  livephoto  video   videopip   smile     gesture   refecous
        MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_FLASH]                 = new int[]{STATE_E0, STATE_R0, STATE_R0, STATE_R0, STATE_R0, STATE_E0, STATE_R0,  STATE_E0, STATE_R0, STATE_E0, STATE_R0, STATE_E0, STATE_E0, STATE_R0};//0: flash
        MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_DUAL_CAMERA]           = new int[]{STATE_E0, STATE_D0, STATE_E0, STATE_D0, STATE_D0, STATE_D0, STATE_D0,  STATE_E0, STATE_D0, STATE_E0, STATE_E0, STATE_D0, STATE_E0, STATE_D0};//1: dual camera
        MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_EXPOSURE]              = new int[]{STATE_E0, STATE_R0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0,  STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0};//2: ev
        MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_SCENCE_MODE]           = new int[]{STATE_E0, STATE_R1, STATE_E0, STATE_R0, STATE_R0, STATE_R0, STATE_E0,  STATE_R0, STATE_D0, STATE_E0, STATE_R0, STATE_E0, STATE_E0, STATE_E0};//3: scence mode
        MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_WHITE_BALANCE]         = new int[]{STATE_E0, STATE_R0, STATE_E0, STATE_E0, STATE_E0, STATE_R0, STATE_E0,  STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_R0, STATE_E0};//4: white balance
        MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_SLOW_MOTION]           = new int[]{STATE_E0, STATE_R0, STATE_R0, STATE_E0, STATE_E0, STATE_R0, STATE_E0,  STATE_R0, STATE_E0, STATE_D0, STATE_R0, STATE_E0, STATE_E0, STATE_R0};//5: slow motion
        MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_COLOR_EFFECT]          = new int[]{STATE_E0, STATE_R0, STATE_R0, STATE_R0, STATE_R0, STATE_R0, STATE_R0,  STATE_R0, STATE_D0, STATE_E0, STATE_R0, STATE_E0, STATE_E0, STATE_R0};//6: color effect
        MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_SELF_TIMER]            = new int[]{STATE_E0, STATE_E0, STATE_E0, STATE_R0, STATE_R0, STATE_E0, STATE_R0,  STATE_E0, STATE_R0, STATE_R0, STATE_R0, STATE_R0, STATE_E0, STATE_E0};//7: self timer
        MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_ZSD]                   = new int[]{STATE_E0, STATE_R0, STATE_R0, STATE_R0, STATE_R0, STATE_R0, STATE_R0,  STATE_R0, STATE_R0, STATE_R0, STATE_R0, STATE_R0, STATE_R0, STATE_E0};//8: zsd
        MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_RECORD_LOCATION]       = new int[]{STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0,  STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0};//10: geo tag
        MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_PICTURE_RATIO]         = new int[]{STATE_E0, STATE_E0, STATE_E0, STATE_D0, STATE_D0, STATE_E0, STATE_E0,  STATE_E0, STATE_D0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0};//21: picture ratio
        MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_PICTURE_SIZE]          = new int[]{STATE_E0, STATE_E0, STATE_E0, STATE_D0, STATE_D0, STATE_E0, STATE_D0,  STATE_E0, STATE_D0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0};//11: picture size
        ...
        MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_TIME_LAPSE]            = new int[]{STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0,  STATE_R0, STATE_E0, STATE_E0, STATE_R0, STATE_E0, STATE_E0, STATE_E0};//18 timelapse
        MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_VIDEO_QUALITY]         = new int[]{STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0,  STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0};//20 video quality
        MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_SLOW_MOTION_VIDEO_QUALITY]    = new int[]{STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0,STATE_E0, STATE_E0, STATE_E0, STATE_E0};//20 video quality
        MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_VOICE]                 = new int[]{STATE_E0, STATE_E0, STATE_E0, STATE_R0, STATE_R0, STATE_E0, STATE_R0,  STATE_E0, STATE_R0, STATE_E0, STATE_R0, STATE_E0, STATE_E0, STATE_E0};//22 voice
        MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_3DNR]                  = new int[]{STATE_E0, STATE_E0, STATE_R0, STATE_E0, STATE_E0, STATE_E0, STATE_E0,  STATE_R0, STATE_E0, STATE_E0, STATE_R0, STATE_E0, STATE_E0, STATE_E0};//23: 3DNR
        MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_SHARPNESS]             = new int[]{STATE_E0, STATE_R0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0,  STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0};//30: image adjustment sharpness
        MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_HUE]                   = new int[]{STATE_E0, STATE_R0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0,  STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0};//31: image adjustment hue
        MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_SATURATION]            = new int[]{STATE_E0, STATE_R0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0,  STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0};//32: image adjustment saturation
        MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_BRIGHTNESS]            = new int[]{STATE_E0, STATE_R0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0,  STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0};//33: image adjustment brightness
        MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_CONTRAST]              = new int[]{STATE_E0, STATE_R0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0,  STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0};//34: image adjustment contrast
        MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_FAST_AF]               = new int[]{STATE_E0, STATE_R0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0,  STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0};//33: Fast AF
        MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_DISTANCE]              = new int[]{STATE_E0, STATE_R0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0,  STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0};//34: Distance info
        MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_CAMERA_MODE]           = new int[]{STATE_R0, STATE_R0, STATE_R0, STATE_R0, STATE_R0, STATE_R0, STATE_R0,  STATE_R0, STATE_R1, STATE_R1, STATE_R1, STATE_R0, STATE_R0, STATE_R0};//21 camera mode
        MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_CAPTURE_MODE]          = new int[]{STATE_R0, STATE_R0, STATE_R2, STATE_R7, STATE_R0, STATE_R3, STATE_R0,  STATE_R0, STATE_R0, STATE_R0, STATE_R0, STATE_E0, STATE_E0, STATE_E0};//22: capture mode
        MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_CONTINUOUS_NUM]        = new int[]{STATE_R0, STATE_D0, STATE_R0, STATE_R0, STATE_R0, STATE_R0, STATE_R0,  STATE_R0, STATE_R0, STATE_R0, STATE_R0, STATE_D0, STATE_D0, STATE_R0};//23: initial continuous number, it is different from 6 for here is real number, 6 is enable/disable state.
        MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_RECORDING_HINT]        = new int[]{STATE_R0, STATE_E0, STATE_R0, STATE_R0, STATE_R0, STATE_R0, STATE_R0,  STATE_R0, STATE_R1, STATE_R1, STATE_R0, STATE_E0, STATE_E0, STATE_R0};//24 recording hint
        MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_JPEG_QUALITY]          = new int[]{STATE_R0, STATE_R0, STATE_R0, STATE_R1, STATE_R1, STATE_R0, STATE_R0,  STATE_R0, STATE_R0, STATE_R0, STATE_R0, STATE_E0, STATE_E0, STATE_R0};//25 jpeg quality
        MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_FACEBEAUTY_SMOOTH]     = new int[]{STATE_E0, STATE_D0, STATE_E0, STATE_D0, STATE_D0, STATE_D0, STATE_D0,  STATE_D0, STATE_D0, STATE_D0, STATE_D0, STATE_E0, STATE_E0, STATE_D0};//47: face beauty smooth
        MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_FACEBEAUTY_SKIN_COLOR] = new int[]{STATE_E0, STATE_D0, STATE_E0, STATE_D0, STATE_D0, STATE_D0, STATE_D0,  STATE_D0, STATE_D0, STATE_D0, STATE_D0, STATE_E0, STATE_E0, STATE_D0};//48: face beauty skin-color
        MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_FACEBEAUTY_SHARP]      = new int[]{STATE_E0, STATE_D0, STATE_E0, STATE_D0, STATE_D0, STATE_D0, STATE_D0,  STATE_D0, STATE_D0, STATE_D0, STATE_D0, STATE_E0, STATE_E0, STATE_D0};//49: face beauty sharp
        MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_FACEBEAUTY_SLIM]       = new int[]{STATE_E0, STATE_D0, STATE_E0, STATE_D0, STATE_D0, STATE_D0, STATE_D0,  STATE_D0, STATE_D0, STATE_D0, STATE_D0, STATE_E0, STATE_E0, STATE_D0};//49: face beauty sharp
        MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_FACEBEAUTY_BIG_EYES]   = new int[]{STATE_E0, STATE_D0, STATE_E0, STATE_D0, STATE_D0, STATE_D0, STATE_D0,  STATE_D0, STATE_D0, STATE_D0, STATE_D0, STATE_E0, STATE_E0, STATE_D0};//49: face beauty sharp
        MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_CAMERA_FACE_DETECT]    = new int[]{STATE_E0, STATE_E0, STATE_R1, STATE_R0, STATE_R0, STATE_R1, STATE_R0,  STATE_E0, STATE_R0, STATE_R0, STATE_R0, STATE_R1, STATE_R1, STATE_E0};//50: face detection
        MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_MULTI_FACE_MODE]       = new int[]{STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0,  STATE_D0, STATE_E0, STATE_E0, STATE_D0, STATE_E0, STATE_E0, STATE_E0};//55: multi-face mode
        MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_HDR]                   = new int[]{STATE_E0, STATE_E0, STATE_R0, STATE_R0, STATE_R0, STATE_R0, STATE_R0,  STATE_R0, STATE_R0, STATE_E0, STATE_R0, STATE_R0, STATE_R0, STATE_R0};//51: hdr
        MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_SMILE_SHOT]            = new int[]{STATE_E0, STATE_R0, STATE_R0, STATE_R0, STATE_R0, STATE_R0, STATE_R0,  STATE_E0, STATE_R0, STATE_R0, STATE_R0, STATE_E0, STATE_R0, STATE_R0};//52: smile shot
        MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_ASD]                   = new int[]{STATE_E0, STATE_R0, STATE_R0, STATE_R0, STATE_R0, STATE_E0, STATE_R0,  STATE_R0, STATE_R0, STATE_R0, STATE_R0, STATE_R0, STATE_R0, STATE_R0};//53: asd
        MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_MUTE_RECORDING_SOUND]  = new int[]{STATE_R0, STATE_R0, STATE_R0, STATE_R0, STATE_R0, STATE_R0, STATE_R0,  STATE_R0, STATE_R1, STATE_R0, STATE_R0, STATE_E0, STATE_E0, STATE_R0};//54 enable recording sound
        MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_GESTURE_SHOT]          = new int[]{STATE_E0, STATE_R0, STATE_E0, STATE_R0, STATE_R0, STATE_R0, STATE_R0,  STATE_E0, STATE_R0, STATE_R0, STATE_R0, STATE_R0, STATE_E0, STATE_R0};//55 gesture shot
    }
    ...
    private static final int[] RESTRCTION_SETTING_INDEX = new int[] {
        ...
        SettingConstants.ROW_SETTING_MAV,
        SettingConstants.ROW_SETTING_ASD,
        SettingConstants.ROW_SETTING_MOTION_TRACK,
        SettingConstants.ROW_SETTING_PHOTO_PIP,
        SettingConstants.ROW_SETTING_LIVE_PHOTO,
    ...
    static {
        ...
        DEFAULT_VALUE_FOR_SETTING[SettingConstants.ROW_SETTING_MAV]                      = "off";
        DEFAULT_VALUE_FOR_SETTING[SettingConstants.ROW_SETTING_MOTION_TRACK]             = "off";
        ...
        DEFAULT_VALUE_FOR_SETTING[SettingConstants.ROW_SETTING_LIVE_PHOTO]               = "off";
    ...
    private static final String PICTURE_RATIO_4_3 = "1.3333";//modified by wangyouyou
    private static final String PICTURE_RATIO_1_1 = "1.0";//added by wangyouyou
   ...
   private static final String[] PICTURE_SIZE_1_1 = new String[] {
    ...
    private static final Restriction[] RESTRICTIOINS = new Restriction[]{
        ...
        new Restriction(SettingConstants.ROW_SETTING_FAST_AF)
              .setValues("on")
              .setRestrictions(new Restriction(SettingConstants.ROW_SETTING_PICTURE_RATIO)
                  .setEnable(true)
       ...
       new Restriction(SettingConstants.ROW_SETTING_DISTANCE)
        ...
        new Restriction(SettingConstants.ROW_SETTING_LIVE_PHOTO)
            .setValues("on")
            .setRestrictions(
                new Restriction(SettingConstants.ROW_SETTING_SCENCE_MODE)
                    .setEnable(true)
