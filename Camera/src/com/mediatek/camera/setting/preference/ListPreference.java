...
public class ListPreference extends CameraPreference {
    ...
    public ListPreference(Context context, AttributeSet attrs, SharedPreferencesTransfer prefTransfer) {
    ...
    public String getValue() {
        if (!mLoaded) {
            ...
            Log.d(TAG, "[getValue]reload defaultValue=" + defaultValue + ", real=" + mValue+",mkey = " + mKey);
            ...
            if (mValue == null && SettingConstants.KEY_MULTI_FACE_BEAUTY.equals(mKey)) {
                ...
                Log.d(TAG, "[getValue]reload defaultValue=.......................................");
            }
        }
        return mValue;
    }
    ...
    public void setValue(String value) {
        ...
        //mValue = value;//del by wangyouyou
        //persistStringValue(value); //del by wangyouyou
    }

    //begin: added by wangyouyou
    public void changeFlashOrHdrModeIcon(String str){
	mValue = str;
    ...
    public synchronized void print() {
        if (mEntryValues == null || mDefaultValues == null) {
            Log.w(TAG, "[print]mEntryValues=" + mEntryValues + ", mDefaultValues=" + mDefaultValues);
            return;
        }
