...
public class CameraAppGuide implements IAppGuide {
    ...
    public void showCameraGuide(String type, final OnGuideFinishListener onFinishListener) {
        ...
        if (isGmoROM()
                || (CAMERA_TYPE.equals(type) && mSharedPrefs.getBoolean(KEY_CAMERA_GUIDE, true))//mody by xss  from false to ture
                || (MAV_TYPE.equals(type) && mSharedPrefs.getBoolean(KEY_CAMERA_MAV_GUIDE, true))) {//mody by xss  from false to ture
