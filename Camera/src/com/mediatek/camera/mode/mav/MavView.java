...
public class MavView extends CameraView {
    ...
    public void init(Activity activity, ICameraAppUi cameraAppUi, IModuleCtrl moduleCtrl) {
        ...
        mMavEffectView = new MavEffectView(activity, previewLeft, -2000, previewWidth,
                previewHeight, frameWidth, frameHeight);//modified by wangyouyou from previewTop to -1000
	 //Log.d("wyy", "previewLeft = "+previewLeft+" , previewTop = "+previewTop);
    }
